<div class="neraca container">
    ...
    <form action="<?= BASEURL; ?>/modal/tambah" method="post">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control convert-data" id="modal_dana" name="modal_dana" autocomplete="off">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="hutang" class=" col-sm-4 form-label">Hutang</label>
            <div class="col-sm-6">
                <input type="text" class="form-control convert-data" id="hutang" name="hutang" autocomplete="off">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="penambahan_modal" class=" col-sm-4 form-label">Penambahan Modal</label>
            <div class="col-sm-6">
                <input type="text" class="form-control convert-data" id="penambahan_modal" name="penambahan_modal" autocomplete="off">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="rugi_tahun" class=" col-sm-4 form-label">Rugi Tahun</label>
            <div class="col-sm-6">
                <input type="text" class="form-control convert-data" id="rugi_tahun" name="rugi_tahun" autocomplete="off">
            </div>
        </div>
        <div class="mb-3 row">
            <label for="total_aktiva" class=" col-sm-4 form-label">Total Aktiva</label>
            <div class="col-sm-6">
                <input type="text" class="form-control convert-data" id="total_aktiva" name="total_aktiva" autocomplete="off">
            </div>
        </div>
